...
\label{sec:software}
    ...
    \subsection{Digitale Filterung auf dem Mikrocontroller}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.90\textwidth]{figures/Filter.png}
